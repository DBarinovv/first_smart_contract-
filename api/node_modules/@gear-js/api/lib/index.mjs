...
function readState(wasmBytes, initialSize, pages, inputValue, blockTimestamp) {
    return __awaiter(this, void 0, void 0, function* () {
...
class GearProgramState extends GearStorage {
    ...
    read(programId, metaWasm, inputValue) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const state = yield readState(metaWasm, initialSize, pages, encodedInput, blockTimestamp);
